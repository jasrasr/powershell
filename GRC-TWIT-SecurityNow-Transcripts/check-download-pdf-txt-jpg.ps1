...
$test = 'C:\Users\Jason.Lamb\OneDrive - Cooper Machinery Services\Documents\Github\test-grc-folder-download'
$global:downloadbase = "$test\PowerShell\GRC-TWIT-SecurityNow-Transcripts\Downloads"
$global:baseUrl = "https://www.grc.com/sn/"
$global:jpgBaseUrl = "https://www.grc.com/SN/"

$startingPointTXT = 1     # 001
$startingPointPDF = 595
$startingPointJPG = 800     # Changed from 999 to 1 to grab full range
