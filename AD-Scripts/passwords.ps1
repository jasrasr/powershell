...
#$weakpasswordsfilepath = 'C:\temp\pw.txt'
$weakpasswordsfilepath = 'C:\Users\jason.lamb\OneDrive - middough\Downloads\middough_bad_password_list_extended.txt'
$results = (get-adreplaccount -all -server $server | Test-ADPasswordQuality -weakpasswordsfile $weakpasswordsfilepath | Tee-Object -FilePath C:\temp\middoughpasswordsreport2.txt)
